      ...
      <div className='fContent sectionPadding'>
          ...
          <div className='fCredit'>
            ...
            <div className='fCreditContainer'>
              ...
              <p>Made With <i class="fa-solid fa-heart"></i> By <Link target='_blank' className='fLinks' style={{textDecoration:"underline"}} to='https://digitigers.in/'>DigiTigers</Link></p>
            </div>
          </div>
      </div>
    </div>
